...
sort:
    ...
    # Intercambiamos el valor máximo con el último elemento de la sublista
    lw   $t0, 0($a1)           # Cargamos el último elemento en $t0
    sw   $t0, 0($v0)           # Guardamos el último elemento en la posición del máximo
    sw   $v1, 0($a1)           # Guardamos el máximo en la última posición

    # Preparamos para la siguiente iteración con una lista más pequeña
    addi $a1, $a1, -4          # Mover puntero $a1 una posición hacia atrás
